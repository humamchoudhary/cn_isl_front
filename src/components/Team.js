...
const team = [
  ...
  },
  {
    ...
    imageSrc: 'https://dummyimage.com/150x150/d4d4d4/171717',
    title: 'Department of Software and Communications Engineering College of Science and Technology, Hongik University (Sejong), Korea',
    description:
  ...
  },
  {
    ...
    imageSrc: 'https://dummyimage.com/150x150/d4d4d4/171717',
    title: 'Associate Professor and Chairperson Department of Electronics, Quaid-i-Azam University.',
    description:
...
export default function Team() {
  ...
  return (
    <Container className={"py-24"}>
      <div id='members' className="mx-auto flex max-w-3xl flex-col space-y-7 text-center">
      ...
      <div className="mt-14 grid grid-cols-1 gap-10 sm:grid-cols-2 lg:mt-24 lg:grid-cols-3">
        {team.map((member) => (
          <div key={member.id} className="flex flex-col space-y-6 text-center">
            ...
            <div className="mx-auto mt-2 max-w-md text-base text-justify text-dark   ">
              {expandedMember === member.id
                ? member.description
                : member.description.length > MAX_DESCRIPTION_LENGTH
                ? `${member.description.substring(0, MAX_DESCRIPTION_LENGTH)}...`
                : member.description}
              {member.description.length > MAX_DESCRIPTION_LENGTH && (
                <button
